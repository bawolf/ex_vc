...
4. Run in `libs/ex_vc`:
   - `EX_VC_USE_LOCAL_DEPS=1 mix ex_vc.release.gate`
...
9. Review the standalone repo diff and run `mix ex_vc.release.gate` in the standalone repo before pushing.
...
11. Verify the new release on Hex and GitHub after the workflow completes.
